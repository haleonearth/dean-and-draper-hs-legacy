...
$(function(){"use strict";var t=void 0!==window.hsInEditor&&window.hsInEditor;[function(){var t=$(".social-media--sharing");0<t.length&&t.find(".social-media__service").on("click",function(t){var i,e,o,n,s,r,c,l;t.preventDefault(),i=$(this).attr("href"),e=500,o=300,n=void 0!==window.screenLeft?window.screenLeft:screen.left,s=void 0!==window.screenTop?window.screenTop:screen.top,r=(window.innerWidth?window.innerWidth:document.documentElement.clientWidth?document.documentElement.clientWidth:screen.width)/2-e/2+n,c=(window.innerHeight?window.innerHeight:document.documentElement.clientHeight?document.documentElement.clientHeight:screen.height)/2-o/2+s,(l=window.open(i,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width="+e+",height="+o+",top="+c+",left="+r)).focus&&l.focus()})},function(){var t,i,e,o,n,s,r,c=$(".sticky-row"),l=$(".sticky-row-stop");0<c.length&&(t="sticky-row-placeholder",c.hasClass("sticky-row--sharing")&&(t+=" sticky-row-placeholder--sharing"),c.wrap("<div class='"+t+"'></div>"),i=window.themeUtility.debounce(10,function(){c.toggleClass("sticky-row--stuck",$(window).scrollTop()>n-80),0<l.length&&n<s&&(c.toggleClass("sticky-row--stopped",$(window).scrollTop()+c.outerHeight()+80>s),c.hasClass("sticky-row--stopped")?c.css("top",s-o.offset().top-c.outerHeight()):c.css("top",""))}),e=window.themeUtility.debounce(10,function(){o.height(c.outerHeight())}),o=$(".sticky-row-placeholder"),s=n=0,(r=window.themeUtility.debounce(10,function(){n=o.offset().top,0<l.length&&(s=l.offset().top-parseInt(l.css("margin-top")))}))(),e(),i(),$(window).on("load resize",r).on("load resize",e).on("load resize scroll",i))},function(){var e=$(".landing .widget-type-form"),t=window.themeUtility.throttle(50,function(){e.css("margin-top",0);var t=$(".landing-hero"),i=e.offset().top-(t.offset().top+50);e.css("margin-top",-i)});0<e.length&&(t(),$(window).on("load resize",t))},function(){window.lazyLoadInstance=new LazyLoad({elements_selector:".lazy"}),t||$(".colored-section").not(".no-parallax").each(function(){$(this).jarallax({speed:.8,automaticResize:!0,imgPosition:$(this).css("background-position")})});function i(t){return t.is(":visible")&&(void 0===t.data("visible")||t.data("visible"))&&$(window).scrollTop()+$(window).height()-100>t.offset().top}$(".trigger-when-visible").each(function(){i($(this))&&($(this).is("svg")?$(this).attr("class",$(this).attr("class")+" trigger-when-visible--visible"):$(this).addClass("trigger-when-visible--visible"))}),$(window).on("load scroll resize triggerwhenvisible",window.themeUtility.throttle(100,function(t){$(".trigger-when-visible:not(.trigger-when-visible--visible)").each(function(){i($(this))&&($(this).is("svg")?$(this).attr("class",$(this).attr("class")+" trigger-when-visible--visible"):$(this).addClass("trigger-when-visible--visible"))})}));var e='[class*="_subscription"].hs-fieldtype-radio';$(".widget-type-form, .widget-type-blog_subscribe").on("click",e+" > label",function(){$(this).closest(".hs-form-field").toggleClass("hs-field-active")}),$(window).on("click",function(t){$(t.target).closest(e).length<1&&$(e).removeClass("hs-field-active")}).on("load",function(){$(e).children("label").attr("tabindex","0")}),$("a.video-link, .video-link a").magnificPopup({type:"iframe"})}].forEach(function(t){t()})}),window.themeUtility={isNumeric:function(t){return!isNaN(parseFloat(t))&&isFinite(t)},insertUrlParam:function(t,i){var e,o;history.pushState&&(e=new URLSearchParams(window.location.search),i?e.set(t,i):e.delete(t),o=window.location.protocol+"//"+(window.location.host+window.location.pathname),0<e.toString().length&&(o+="?"+e.toString()),window.history.replaceState({path:o},"",o))},getUrlParam:function(t,i){for(var e=window.location.search.substring(1).split("&"),o=0;o<e.length;o++){var n=e[o].split("=");if(n[0]===t){var s=decodeURIComponent(n[1].replace(/\+/g,"%20"));return"true"===s?!0:window.themeUtility.isNumeric(s)?parseFloat(s):s}}return void 0!==i&&i},throttle:function(n,s,r,c){var l,a=0;function t(){var t=this,i=new Date-a,e=arguments;function o(){a=+new Date,r.apply(t,e)}c&&!l&&o(),l&&clearTimeout(l),void 0===c&&n<i?o():!0!==s&&(l=setTimeout(c?function(){l=void 0}:o,void 0===c?n-i:n))}return"boolean"!=typeof s&&(c=r,r=s,s=void 0),$.guid&&(t.guid=r.guid=r.guid||$.guid++),t},debounce:function(t,i,e){return void 0===e?window.themeUtility.throttle(t,i,!1):window.themeUtility.throttle(t,e,!1!==i)},submitHsForm:function(t,i,e,o){void 0===o&&(o={});var n=document.cookie.replace(/(?:(?:^|.*;\s*)hubspotutk\s*\=\s*([^;]*).*$)|^.*$/,"$1");n&&(e.hutk=n),$.ajax({type:"POST",url:"https://api.hsforms.com/submissions/v3/integration/submit/"+window.themeVars.portalId+"/"+t,contentType:"application/json",data:JSON.stringify({fields:i,context:e}),error:"function"==typeof o.error?o.error:console.log,success:"function"==typeof o.success?o.success:function(){},complete:"function"==typeof o.complete?o.complete:function(){}})}};
/*!
